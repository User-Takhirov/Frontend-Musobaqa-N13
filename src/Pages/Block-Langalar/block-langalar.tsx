...
import { UmumiySearch } from "../Umumiy/UmumiySearch/umumiy-search";


export const BlockLangalar = () => {
  ...
  const filteredData = data?.filter(
    (item: DataSourceType) => item.status === "Block"
  );
    ...
    },
    {
      ...
      render: (_: any, record: DataSourceType) => (
        <Button onClick={() => handleStatusClick(record)}>
          {record.status}
        </Button> // Click to open status edit modal
      ),
    },
    {
      title: "",
